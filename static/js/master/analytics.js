    ...
    function La(a) {
        ...
        var k = this, w = function (a, b) {
                ...
                for (var d = [], e = 0; e < c.length; e += 3) {
                    var g = e + 1 < c.length, ca = e + 2 < c.length, Ee = c.charCodeAt(e), l = g ? c.charCodeAt(e + 1) : 0,
                        w = ca ? c.charCodeAt(e + 2) : 0, k = Ee >> 2;
                    Ee = (Ee & 3) << 4 | l >> 4;
                    l = (l & 15) << 2 | w >> 6;
                    w &= 63;
                    ca || (w = 64, g || (l = 64));
        ...
        a:{
            if (b[Kd]) {
                ...
                if (void 0 !== Ab) b[Q] || (b[Q] = Ab); else {
                    b:if (d =
                        String(b[W] || xa()), e = String(b[Yb] || "/"), g = Ca(String(b[U] || "_ga")), d = na(g, d, e), !d || jd.test(d)) d = !0; else if (d = Ca("AMP_TOKEN"), 0 == d.length) d = !0; else {
